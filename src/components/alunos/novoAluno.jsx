...
const NovoAluno = ({ id,name, dataN }) => {
    ...
    return (
        <>
       <div class="modal fade" id="novoAluno" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="row-addPlayer-Title">
                                            ...
                                            <ul class="nav nav-pills h-100 justify-content-center" id="pills-tab" role="tablist">
                                                ...
                                                <li class="nav-item add-Player-Button" role="presentation">
                                                    <button class="nav-link active add-Player-Button-Container w-100 h-100" id="pills-personalProfessor-tab" data-toggle="pill" data-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Informação pessoal</button>
                                                </li>

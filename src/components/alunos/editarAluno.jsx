...
const EditarAluno = ({ id,name,nascimento, matricula }) => {
 ...
 const date =()=>{
    return(document.getElementById("alunoDate").defaultValue=nascimento)
 }
    ...
    return (
        <>
           <div class="modal fade" id="editarAluno" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input class="form-control" id="SearchInput" defaultValue={nascimento}  /> 

                                                <label className='form-label'>
                                                    Matricula
                                                </label>
                                                <input class="form-control" id="SearchInput" defaultValue={matricula}  /> 

...
const EditarProfessor = ({ id, name, nascimento, vencimento }) => {
    ...
    return (
        <>
            <div class="modal fade" id="editarProfessor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input class="form-control" id="SearchInput" defaultValue={vencimento} />
                                            </div>

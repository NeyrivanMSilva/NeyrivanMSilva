...
const VerProfessor = ({ id,name, nascimento, vencimento }) => {
    ...
    return (
        <>
          <div class="modal fade" id="verProfessor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document" id='modal1'>
                    <div class="modal-content" id='modal2'>
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Ver professor</h5>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input class="form-control" id="SearchInput" value={vencimento} disabled/> 
